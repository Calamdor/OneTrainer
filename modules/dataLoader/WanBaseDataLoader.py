...
class WanBaseDataLoader(
    ...
    def _cache_modules(self, config: TrainConfig, model: WanModel, model_setup: BaseWanSetup):
        ...
        # Always cache text encoder output (never trained).
    ...
    def _output_modules(self, config: TrainConfig, model: WanModel, model_setup: BaseWanSetup):
        output_names = [
...
factory.register(BaseDataLoader, WanBaseDataLoader, ModelType.WAN2_2_T2V)
