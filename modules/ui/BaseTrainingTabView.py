...
class BaseTrainingTabView(ABC):
    ...
    def build(self, column_0, column_1, column_2, controller, ui_state):
        ...
        if model_type.is_stable_diffusion_3():
            ...
            self.__setup_ltx_ui(column_0, column_1, column_2, controller, ui_state)
    ...
    def __setup_ltx_ui(self, column_0, column_1, column_2, controller, ui_state):
        self.__create_base_frame(column_0, 0, controller, ui_state)
        self.__create_text_encoder_frame(column_0, 1, ui_state, supports_clip_skip=False, supports_training=False)
        self.__create_embedding_frame(column_0, 2, ui_state)
    ...
    def __create_base_frame(self, master, row, controller, ui_state):
        ...
        self.components.label(frame, 4, 0, "Learning Rate Min Factor",
        ...
        self.components.label(frame, 5, 0, "Learning Rate Cycles",
        ...
        # accumulation steps
        self.components.label(frame, 8, 0, "Accumulation Steps",
        ...
        self.components.label(frame, 9, 0, "Learning Rate Scaler",
    ...
    def __create_base2_frame(self, master, row, controller, ui_state, video_training_enabled: bool = False,
        ...
        self.components.label(frame, row, 0, "Fallback Train Data Type",
        ...
        # autocast cache
        self.components.label(frame, row, 0, "Autocast Cache",
        ...
        if video_training_enabled:
            self.components.label(frame, row, 0, "Frames",
        ...
        if supports_circular_padding:
            self.components.label(frame, row, 0, "Force Circular Padding",
    ...
    def __create_text_encoder_frame(self, master, row, ui_state, supports_clip_skip=True, supports_training=True,
        ...
        if supports_sequence_length:
            ...
            self.components.label(frame, row, 0, "Text Encoder Sequence Length",
    ...
    def __create_text_encoder_n_frame(
        ...
        if supports_include:
            ...
            self.components.label(frame, row, 0, f"Include Text Encoder {i}",
        ...
        # train text encoder
        self.components.label(frame, row, 0, f"Train Text Encoder {i}",
        ...
        # dropout
        self.components.label(frame, row, 0, "Dropout Probability",
        ...
        # text encoder learning rate
        self.components.label(frame, row, 0, f"Text Encoder {i} Learning Rate",
        ...
        if supports_layer_skip:
            # text encoder layer skip (clip skip)
            self.components.label(frame, row, 0, f"Text Encoder {i} Clip Skip",
                                  tooltip="The number of additional clip layers to skip. 0 = the model default")
        ...
        if supports_sequence_length:
            # text encoder sequence length
            self.components.label(frame, row, 0, f"Text Encoder {i} Sequence Length",
    ...
    def __create_embedding_frame(self, master, row, ui_state):
        ...
        self.components.label(frame, 1, 0, "Preserve Embedding Norm",
    ...
    def __create_loss_frame(self, master, row, controller, ui_state,
        ...
        # MAE Strength
        self.components.label(frame, 1, 0, "MAE Strength",
        ...
        # Huber Strength
        self.components.label(frame, 3, 0, "Huber Strength",
        ...
        if supports_vb_loss:
            # VB Strength
            self.components.label(frame, 5, 0, "VB Strength",
        ...
        # Loss Scaler
        self.components.label(frame, row, 0, "Loss Scaler",
