...
def _get_model_defaults(model_type) -> dict:
    ...
    if model_type.is_sd_v1():
        ...
        defaults.update({
            ...
            "steps_high": 10,
            "steps_low": 10,
            # Canonical Wan2.2 T2V negative prompt (Chinese, from the
            # official model card). Covers oversaturation, blur, low quality,
            # JPEG artifacts, malformed hands/faces, static frames, etc.
            "negative_prompt": (
